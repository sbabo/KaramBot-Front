...
<section class="msger">
  <header class="msger-header">
    <div class="msger-header-title">
      <i class="fas fa-comment-alt"></i> Super Bot
    </div>
  ...
  <main class="msger-chat" id="main">
    <div class="msg left-msg">
      ...
      <div class="msg-bubble">
        <div class="msg-info">
          <div class="msg-info-name">KaramBot</div>
          <div class="msg-info-time">12:45</div>
        </div>

        <div class="msg-text">
          Salut mec. Je fais des super blagues. N'hésite pas à me demander. :voix de robot:
        </div>
      </div>
    </div>
    ...
    <div class="msg right-msg">
      ...
      <div class="msg-bubble">
        <div class="msg-info">
          <div class="msg-info-name">Utilisateur</div>
